...
export function AttendanceProvider({ children }: { children: ReactNode }) {
	const [attendanceRecords, setAttendanceRecords] =
		useState<AttendanceRecord[]>(getInitialAttendance())
			...
			setAttendanceRecords((prev) => {
				...
				if (existingIndex !== -1) {
					...
					if (status === "presente") {
						...
						checkIn = lateTime.toLocaleTimeString("es-ES", {
							hour: "2-digit",
							minute: "2-digit",
							hour12: true,
						})
						...
						checkOut = halfDayOut.toLocaleTimeString("es-ES", {
							hour: "2-digit",
							minute: "2-digit",
							hour12: true,
						})
	...
	const contextValue = useMemo(
		...
		[attendanceRecords, todayAttendance, markAttendance, getAttendanceByDate]
	)
